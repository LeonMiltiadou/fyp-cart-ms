...
var _require = require('./fetchcart'),
    fetchCart = _require.fetchCart,
    cartFunction = _require.cartFunction;

describe("fetchcart", function () {
  test("SHOULD successfully fetchcart RESPOND with status code and data", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cartFunction.handleFetchCart = jest.fn().mockReturnValue({
              data: expectedData,
