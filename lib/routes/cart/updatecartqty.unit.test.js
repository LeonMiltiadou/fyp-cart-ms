...
var _require = require('./updatecartqty'),
    updateCartQty = _require.updateCartQty,
    cartFunction = _require.cartFunction;

describe("removefromcart", function () {
  test("SHOULD successfully removefromcart RESPOND with status code and data", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cartFunction.handleUpdateCartQty = jest.fn().mockReturnValue({
              data: expectedData,
              status: expectedStatus
            });
            _context.next = 7;
            return updateCartQty(req, res);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            cartFunction.handleUpdateCartQty = jest.fn().mockReturnValue(expectedResponse);
            _context2.next = 8;
            return updateCartQty(req, res);
