...
var updateCartQty = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var _req$body, cartID, lineItemId, quantity, cart, errorMsg;

    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _req$body = req.body, cartID = _req$body.cartID, lineItemId = _req$body.lineItemId, quantity = _req$body.quantity;
            _context.next = 3;
            return exportFunctions.cartFunction.handleUpdateCartQty(cartID, lineItemId, quantity);
  ...
  return function updateCartQty(_x, _x2) {
