...
var removeFromCart = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var _req$params, cartID, lineItemId, cart, errorMsg;

    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _req$params = req.params, cartID = _req$params.cartID, lineItemId = _req$params.lineItemId;
            _context.next = 3;
            return exportFunctions.cartFunction.handleRemoveFromCart(cartID, lineItemId);
