...
var _require = require('./createcart'),
    createCart = _require.createCart,
    cartFunction = _require.cartFunction;

describe("createcart", function () {
  test("SHOULD successfully createcart RESPOND with status code and data", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cartFunction.handleCreateCart = jest.fn().mockReturnValue({
              data: expectedData,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            cartFunction.handleCreateCart = jest.fn().mockReturnValue(expectedResponse);
            _context2.next = 8;
            return createCart(req, res);
