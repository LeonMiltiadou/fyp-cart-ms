...
var _require = require('./addtocart'),
    addToCart = _require.addToCart,
    cartFunction = _require.cartFunction;

describe("addtocart", function () {
  test("SHOULD successfully addtocart RESPOND with status code and data", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cartFunction.handleAddToCart = jest.fn().mockReturnValue({
              data: expectedData,
