...
module.exports = {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return cartAPI.post(cartID, {
                ...
                var baseErrorMsg = "There was an error while adding the item to the cart";
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return cartAPI.put(cartID + "/items/" + lineItemId, {
                ...
                var baseErrorMsg = "There was an error while updating the item quantity in the cart";
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return cartAPI["delete"](cartID + "/items/" + lineItemId).then(function (cart) {
                ...
                var baseErrorMsg = "There was an error while removing the item from the cart";
          ...
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return cartAPI["delete"](cartID + "/items").then(function (cart) {
                ...
                var baseErrorMsg = "There was an error while emptying the cart";
  ...
  */
  handleFetchCart: function () {
    var _handleFetchCart = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(cartID) {
          ...
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return cartAPI.get(cartID).then(function (cart) {
                ...
                var baseErrorMsg = "There was an error while fetching the cart";
    ...
    function handleFetchCart(_x10) {
      return _handleFetchCart.apply(this, arguments);
    }

    return handleFetchCart;
  }(),
  ...
  * https://commercejs.com/docs/sdk/cart
  */
  handleCreateCart: function () {
    var _handleCreateCart = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
          ...
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return cartAPI.get().then(function (cart) {
                ...
                var baseErrorMsg = "There was an error while creating the cart";
    ...
    function handleCreateCart() {
      return _handleCreateCart.apply(this, arguments);
    }
