let { removeFromCart, cartFunction } = require('./removefromcart');
...
describe("removefromcart", () => {
    test("SHOULD successfully removefromcart RESPOND with status code and data", async () => {
        ...
        let req = {params:{cartID: 1, lineItemId: 2}};
        ...
        cartFunction.handleRemoveFromCart = jest.fn().mockReturnValue({ data: expectedData, status: expectedStatus });
    ...
    test("SHOULD log 500 error BECAUSE request was never sent to external server SENDS status code 500, and error msg and data as a json object", async function () {
        ...
        cartFunction.handleRemoveFromCart = jest.fn().mockReturnValue(expectedResponse);
