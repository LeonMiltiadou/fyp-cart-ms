let { emptyCart, cartFunction } = require('./emptycart');

describe("emptycart", () => {
    test("SHOULD successfully emptycart RESPOND with status code and data", async () => {
        ...
        cartFunction.handleEmptyCart = jest.fn().mockReturnValue({ data: expectedData, status: expectedStatus });
