let { createCart, cartFunction } = require('./createcart');

describe("createcart", () => {
    test("SHOULD successfully createcart RESPOND with status code and data", async () => {
        ...
        cartFunction.handleCreateCart = jest.fn().mockReturnValue({ data: expectedData, status: expectedStatus });
