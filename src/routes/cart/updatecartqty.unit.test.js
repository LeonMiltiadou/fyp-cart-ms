let { updateCartQty, cartFunction } = require('./updatecartqty');

describe("removefromcart", () => {
    test("SHOULD successfully removefromcart RESPOND with status code and data", async () => {

        const expectedStatus = 200;
        const expectedData = 1;

        let req = {body:{ cartID : 1, lineItemId : 2, quantity: 3}};
        ...
        cartFunction.handleUpdateCartQty = jest.fn().mockReturnValue({ data: expectedData, status: expectedStatus });
